...
https://docs.spring.io/spring-boot/docs/1.5.17.RELEASE/reference/htmlsingle/[spring-boot-1.5.16.RELEASE] , 
https://docs.spring.io/spring-security/site/docs/4.2.9.RELEASE/reference/htmlsingle/[spring-security-4.2.8.RELEASE] 
기반으로 동작합니다.

== RememberMeServices 

https://docs.spring.io/spring-security/site/docs/4.2.9.RELEASE/reference/htmlsingle/[spring-security] 는 
